...
const getProfileDesc = `${serverIp}/group/getProfileDesc`
const makeAdmin = `${serverIp}/makeAdmin`
const removeAsAdmin = `${serverIp}/removeAsAdmin`
const removeUserFromGroup = `${serverIp}/removeUserFromGroup`
const updateGroupsMembers = `${serverIp}/updateGroupsMembers`
const addUsersToGroup = `${serverIp}/addUsersToGroup`
